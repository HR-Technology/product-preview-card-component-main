# Frontend Mentor: solución de componente de tarjeta de vista previa del producto

Esta es una solución al [desafío del componente de la tarjeta de vista previa del producto en Frontend Mentor] (https://www.frontendmentor.io/challenges/product-preview-card-component-GO7UmttRfa). Los desafíos de Frontend Mentor lo ayudan a mejorar sus habilidades de codificación mediante la creación de proyectos realistas.
